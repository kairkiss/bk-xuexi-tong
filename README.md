...
> 学习通 / 超星课程任务桌面助手。第一版从 macOS 起步，目标是逐步补齐 Windows、Linux，做成真正跨平台、可视化、本地运行的学习通 / 超星桌面 App。

**BK Chaoxing Desktop** 基于 `Samueli924/chaoxing` 的 Python core 封装而来，第一阶段先把原本偏脚本化、终端化的课程任务流程做成 macOS 桌面应用；后续会继续扩展到 Windows 和 Linux，并加入 AI 学习辅助能力。
...
- 想把学习通 / 超星自动化流程做成一个真正能交付、能分发、能迭代的桌面产品；
- 想在未来加入 AI 题目解析、知识点讲解、错题复盘，而不是只停留在“能跑脚本”；

那这个项目就是为这个方向准备的。

**一句话：BK Chaoxing Desktop 要把学习通 / 超星从网页和脚本里解放出来，变成一个本地、可视化、可诊断、可扩展的桌面 App。**
